  ...
  if (isTouchDevice()) {
    ...
    if (
      ...
      currentDrop.insertAdjacentHTML(
        "afterbegin",
        `<img src= "hhijaiyahh/${currentElement.id}.png" class="img-fluid">`
      );
      count += 1;
    }
  } else {
    ...
    if (draggedElementData === droppableElementData) {
      ...
      e.target.insertAdjacentHTML(
        "afterbegin",
        `<img src="hhijaiyahh/${draggedElementData}.png" class="img-fluid">`
      );
      count += 1;
    }
  }
...
if (count == jml) {
    result.innerText = `Kamu Hebat!`;
    stopGame();
    winLink.style.display = "block"; //show the link
  }
...
const creator = () => {
  ...
  for (let i of randomData) {
    ...
    flagDiv.innerHTML = `<img src="hhijaiyahh/${i}.png" class="img-fluid" id="${i}">`;
