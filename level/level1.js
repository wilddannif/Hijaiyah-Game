  ...
  if (isTouchDevice()) {
    ...
    if (
      ...
      currentDrop.insertAdjacentHTML(
        "afterbegin",
        `<img src= "gambar/${currentElement.id}.jpg" class="img-fluid">`
      );
      count += 1;
    }
  } else {
    ...
    if (draggedElementData === droppableElementData) {
      ...
      e.target.insertAdjacentHTML(
        "afterbegin",
        `<img src="gambar/${draggedElementData}.jpg" class="img-fluid">`
      );
      count += 1;
    }
  }
...
const creator = () => {
  ...
  for (let i of randomData) {
    ...
    flagDiv.innerHTML = `<img src="gambar/${i}.jpg" class="img-fluid" id="${i}">`;
